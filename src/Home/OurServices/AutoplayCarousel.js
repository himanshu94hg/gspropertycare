...
const AutoplayCarousel = () => {
  const settings = {
    ...
    speed: 500,
    autoplay: true,
    autoplaySpeed: window.innerWidth > 991 ? 3000 : 2000,
  ...
  return (
    <section id="our-services" style={{ marginTop: "-52px" }}>
      <div className="container">
        ...
        <Slider {...settings}>
          ...
          <Link to="/Services/CareBondCleaning">
            <div className="box services-info ">
              <img
                width={370}
                height={216}
              ...
              <div className="box-content">
                ...
                <div className="services-text">
                  Our experts in bond cleaning guarantee you secure the bond
                  back hassle-free with clean rental property which is cleaned
          ...
          <Link to="/Services/CareCarpetCleaning">
            <div className="box services-info ">
              <img
                width={370}
                height={216}
          ...
          <Link to="/Services/CareTilesGroutCleaning">
            <div className="box services-info ">
              <img
                width={370}
                height={216}
              ...
              <div className="box-content">
                ...
                <div className="services-text">
                  With tile and grout cleaning, you can restore the beauty of
                  your floors. It's time to say goodbye to stains and help to
                  clean and fresh surfaces.
                </div>
              </div>
              <div className="services-box">
                <span>
          ...
          <Link to="/Services/CarePlumbers">
            <div className="box services-info ">
              ...
              <div className="box-content">
                ...
                <h5>Care Plumbers</h5>
                <div className="services-text">
                  Plumbing issues can occur anytime and we aim to tackle the
                  issue promptly with our plumbing services.
                </div>
              </div>
              <div className="services-box">
                <span>
          ...
          <Link to="/Services/CareGardening">
            <div className="box services-info ">
              <img
                width={370}
                height={216}
              ...
              <div className="box-content">
                ...
                <div className="services-text">
                  Gardening maintenance is necessary to nurture your green
                  spaces and we can help you create beautiful outdoor
                  environments for you to relish.
                </div>
              </div>
              <div className="services-box">
                <span>
          ...
          <Link to="/Services/CareElectrician">
            <div className="box services-info ">
              <img
                width={370}
                height={216}
          ...
          <Link to="/Services/CareLocksmith">
            <div className="box services-info ">
              <img
                width={370}
                height={216}
              ...
              <div className="box-content">
                ...
                <div className="services-text">
                  ...
                  offer peace of mind and you get lock installations to
