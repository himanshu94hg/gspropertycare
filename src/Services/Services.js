                  ...
                  <div className="box services-info ">
                    ...
                    <div className="box-content">
                      ...
                      <div className="services-text">
                        We believe that moving should be stress-free and we make
                        it possible for our customers. You get efficient and
                        reliable service that ensures a smooth transition to the
                        new home.
                      </div>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 col-sm-6">
                  <div className="box services-info ">
                    ...
                    <div className="box-content">
                      ...
                      <div className="services-text">
                        Our experts in bond cleaning guarantee you secure the
                        bond back hassle-free with clean rental property which
                        is cleaned with our eco-friendly cleaning solutions.
                      </div>
                    </div>
                    <div className="services-box">
                      <span>
                ...
                <div className="col-lg-4 col-md-6 col-sm-6">
                  <div className="box services-info ">
                    ...
                    <div className="box-content">
                      ...
                      <div className="services-text">
                        With tile and grout cleaning, you can restore the beauty
                        of your floors. It's time to say goodbye to stains and
                        help to clean and fresh surfaces.
                      </div>
                    </div>
                    <div className="services-box">
                      <span>
                ...
                <div className="col-lg-4 col-md-6 col-sm-6">
                  <div className="box services-info ">
                    ...
                    <div className="box-content">
                      ...
                      <div className="services-text">
                        Plumbing issues can occur anytime and we aim to tackle
                        the issue promptly with our plumbing services.
                      </div>
                    </div>
                    <div className="services-box">
                      <span>
                ...
                <div className="col-lg-4 col-md-6 col-sm-6">
                  <div className="box services-info ">
                    ...
                    <div className="box-content">
                      ...
                      <div className="services-text">
                        We take security solutions seriously. Our locksmith
                        solutions offer peace of mind and you get lock
                        installations to emergency lockout assistance.
                      </div>
                    </div>
                    <div className="services-box">
                      <span>
